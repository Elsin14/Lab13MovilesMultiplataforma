...
namespace Lab13.ViewModels
{
    public class AlbumesViewModel : BaseViewModel
    {
        ...
        private void CreateArtistas()
        {
            ...
            {
                new Artista {Nombre = "Martin Garrix"},
                new Artista {Nombre = "Green Day"},
                new Artista {Nombre = "Coldplay"},
                new Artista {Nombre = "Grupo 5"},
                new Artista {Nombre = "Dua Lipa"},
                new Artista {Nombre = "Libido"},
                new Artista {Nombre = "Armonia 10"},
                new Artista {Nombre = "Imagine Dragons"},
